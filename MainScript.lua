...
local function loadVape()
	...
	-- Aktiviere/Deaktiviere bestimmte Features nach dem Laden der Einstellungen
	task.spawn(function()
		task.wait(0.5) -- Warte kurz, damit LoadSettings fertig ist
		
		-- Liste der Features, die deaktiviert werden sollen
		local featuresToDisable = {
			"ChestESP", "ChestESPOptionsButton", "ChestESPButton",
			"BedESP", "BedESPOptionsButton", "BedESPButton",
			"BedPlates", "BedPlatesOptionsButton", "BedPlatesButton", "BedPlate",
		...
		local featuresToEnable = {
			"ESP", "ESPOptionsButton", "ESPButton"
		}
